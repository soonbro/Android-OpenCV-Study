...
public class ColorDetectActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2, View.OnTouchListener{
        ...
        public void onManagerConnected(int status) {
            switch (status){
                case LoaderCallbackInterface.SUCCESS: {
                    ...
                    mOpenCvCameraView.setOnTouchListener(ColorDetectActivity.this);
                } break;
                default:{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (CameraBridgeViewBase) findViewById(R.id.color_detection_activity_surface_view);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        Log.i(TAG_OpenCV, "Touch image coordinates: (" + x + ", " + y + ")");
