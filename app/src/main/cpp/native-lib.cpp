...
//
//JNICALL
//Java_kr_ac_ssu_infocom_opencv_1contrib_1test_MainActivity_stringFromJNI(
//        JNIEnv *env,
//        jobject /* this */) {
...
Java_kr_ac_ssu_infocom_opencv_1contrib_1test_Main2Activity_ConvertRGBtoGray(JNIEnv *env,
                                                                           jobject instance,
                                                                           jlong matAddrInput,
                                                                           jlong matAddrResult) {
...
Java_kr_ac_ssu_infocom_opencv_1contrib_1test_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_kr_ac_ssu_infocom_opencv_1contrib_1test_MainActivity_detect(JNIEnv *env, jobject instance,
